                        ...
                        <div class="card-body">
                            ...
                            @empty
                                <div class="text-center">
                                    ...
                                    <p class="card-text">Yuk, jelajahi semua materi yang ada di Build With Arya Course!</p>
                        ...
                        <div class="card-body">
                            @if ($quizResults->isEmpty())
                                <div class="text-center">
                                    ...
                                    <p class="card-text">Yuk, ukur kemampuanmu dengan mengerjakan quiz yang ada di Build With Arya Course!</p>
