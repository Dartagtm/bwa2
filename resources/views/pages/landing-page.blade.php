    ...
    <div class="container">
        <div class="row featurette">
            <div class="col-md-7">
                ...
                <br>
                <p class="lead mx-5">Karena materi di Build With Arya Course ini simpel dan lengkap. Pokoknya bakal sesuai dengan
                    kebutuhanmu.</p>
                <br>
                <a class="btn btn-dark mx-5 text-white" href="{{ route('materi.index') }}">Mulai Belajar</a>
            </div>
            <div class="col-md-5">
                <img src="/img/assets/jumbo.jpeg" width="500" height="500">
            </div>
        </div>
        ...
        <div class="row featurette">
            <div class="col-md-7 order-md-2">
                ...
                <p class="lead mx-5">Belajar With Arya Course mendukung seluruh anak muda di Indonesia untuk tetap bisa belajar, tanpa
        ...
        <div class="bg bg-cust-color bold-shadow rounded-4 p-5 text-center text-white">
            ...
            <p>Yuk belajar bareng Build With Arya Course</p>
